...
from .custom_types import MessageNode, MessageNodes
...
class DiscordService:
    ...
    def __init__(self, config: RootConfig, message_nodes: MessageNodes) -> None:
    ...
    async def send_response_chunks(self, trigger_msg: discord.Message, content: str) -> list[discord.Message]:
        ...
        if not content:
            logger.warning("Discord service recieved no text!")
            return msgs
        ...
        while remaining_text:
            ...
            self.message_nodes[new_msg.id] = node
